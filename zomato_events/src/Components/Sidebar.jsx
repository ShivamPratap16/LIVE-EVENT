    ...
    <div className={sidebarClasses}>
      ...
      <div className={topBarClasses}>
        ...
        <div className={restaurantDashClasses}>
          <div className="text-sm font-medium">Live Event dashboard</div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <ul className="space-y-1">
          ...
          <li>{navItem("/detailed-view", HiOutlineTruck, "submissions")}</li>
          ...
          {/* <li>{navItem("/controlevent", HiOutlineGift, "Controle")}</li> */}
          <li>{navItem("/promotional-campaigns", HiOutlineQuestionMarkCircle, "promotional-campaigns")}</li>
          <li>
            {navItem("/outlet-settings", HiOutlineCog, "Settings")}
          </li>
          <li>
            {navItem("/eventifo", HiOutlineInformationCircle, "Event info")}
          </li>
          <li>
            {navItem("/Editevent", HiOutlineInformationCircle, "Edit info")}
          </li>
          <li>{navItem("/login", HiOutlineQuestionMarkCircle, "Login")}</li>
